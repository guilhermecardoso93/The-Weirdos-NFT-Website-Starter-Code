...
export function Team(imagem, name = "", position = "") {
  const imagens = [
    { image: img01, name: "Guilherme", position: "Manager" },
    { image: img02, name: "Guilherme", position: "Manager" },
    { image: img03, name: "Guilherme", position: "Manager" },
    { image: img04, name: "Guilherme", position: "Manager" },
    { image: img05, name: "Guilherme", position: "Manager" },
    { image: img06, name: "Guilherme", position: "Manager" },
    { image: img07, name: "Guilherme", position: "Manager" },
    { image: img08, name: "Guilherme", position: "Manager" },
    { image: img09, name: "Guilherme", position: "Manager" },
    { image: img10, name: "Guilherme", position: "Manager" },
  ];
