import { Section, Title, Container, Item, ImageContainer, Name, Position } from "./style";
...
function MemberComponent({ img, name = "", position = "" }) {
  return (
    <Item>
      <ImageContainer>
    ...
    <Section>
      ...
      <Container>
        {imagens.map((imagem, index) => (
          <MemberComponent img={imagem} key={index} />
        ))}
      </Container>
    </Section>
  );
